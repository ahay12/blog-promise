    ...
    <div class="flex justify-center items-center h-[100vh]">
      ...
      >
        ...
        <form @submit.prevent="handleSignUp" autocomplete="off">
          ...
          <button
            class="block w-[80%] ml-[40px] select-none rounded-lg bg-gradient-to-tr from-gray-900 to-gray-800 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
            type="submit"
          >
            Sign Up
          </button>
  ...
  setup() {
    ...
    const handleSignUp = async () => {
      try {
        ...
        // create account
        const req = await createUserWithEmailAndPassword(auth, post.email, post.password);
        const user = req.user;
    ...
    return { email, password, role, handleSignUp };
  },
};
</script>
